...
with DAG(
    ...
    def data_transformation(**kwargs):
        ti = kwargs["ti"]
        from Sensor_fault_detection.entity.artifact_entity import DataValidationArtifact
    ...
    def model_trainer(**kwargs):
        ti = kwargs["ti"]
        from Sensor_fault_detection.entity.artifact_entity import DataTransformationArtifact
    ...
    def model_evaluation(**kwargs):
        ti = kwargs["ti"]
        from Sensor_fault_detection.entity.artifact_entity import DataTransformationArtifact,DataValidationArtifact,ModelTrainerArtifact
        data_transformation_artifact = ti.xcom_pull(task_ids="data_transformation", key="data_transformation_artifact")
        data_transformation_artifact = DataTransformationArtifact(**(data_transformation_artifact))

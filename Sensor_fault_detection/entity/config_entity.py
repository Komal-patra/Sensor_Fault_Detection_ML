...
class DataTransformationConfig:
     ...
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
          try:
               ...
               self.transform_object_dir = os.path.join(data_transformation_dir,'transformer')
               self.transform_object_path = os.path.join(self.transform_object_dir, TRANSFORMER_OBJECT_FILE_NAME)
               self.transform_data =os.path.join(data_transformation_dir, 'transform_data')
               self.transform_train_path = os.path.join(self.transform_data, TRAIN_FILE_NAME)
               self.transform_test_path = os.path.join(self.transform_data, TEST_FILE_NAME)
